    ...
    return (
        <Navbar className='navbar'>
                ...
                <Navbar.Text className='pt-4'>
                   <p> <span className='pt-5'>Create account</span> 
                    <button  
                    className='text-primary btn btn-link border-0 mb-1 pb-1' 
                    data-toggle="modal" data-target="#registerModalCenter">
                     It's free
                    </button></p>
                </Navbar.Text>
                </Navbar.Collapse>
